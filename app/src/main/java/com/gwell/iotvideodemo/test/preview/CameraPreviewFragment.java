...
package com.gwell.iotvideodemo.test.preview;
...
public class CameraPreviewFragment extends BaseFragment
    ...
    private void prepareEncode() {
        ...
        if (mEncoderCallback == null) {
            mEncoderCallback = new EncoderCallback();
        }
    ...
    private void prepareMuxer() {
        ...
        File outputFile = new File(videoFilePath);
        ...
        try {
            mMuxer = new MediaMuxer(videoFilePath, MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
    ...
    private String getVideoFilePath() {
        ...
        return dir.getPath() + File.separator + System.currentTimeMillis() + ".mp4";
    }
    ...
    private void startRecordingVideo() {
        ...
        try {
            ...
            // Set up Surface for the MediaCodec
            Surface recorderSurface = mCodec.createInputSurface();
    ...
    private class EncoderCallback extends MediaCodec.Callback{
        ...
        public void onOutputBufferAvailable(@NonNull MediaCodec mediaCodec, int i, @NonNull MediaCodec.BufferInfo bufferInfo) {
            ...
            if (encodedData == null) {
                LogUtils.e(TAG, "onOutputBufferAvailable encode data is null");
                return;
            }
            encodedData.position(bufferInfo.offset);
            encodedData.limit(bufferInfo.offset + bufferInfo.size);
            LogUtils.d(TAG, "onOutputBufferAvailable, info.size: " + bufferInfo.size);
        ...
        public void onOutputFormatChanged(@NonNull MediaCodec mediaCodec, @NonNull MediaFormat mediaFormat) {
            LogUtils.d(TAG, "onOutputFormatChanged: " + mediaFormat);
